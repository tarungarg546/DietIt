<?php
	...
	$query1=mysqli_query($con,"SELECT * FROM calorietable") or die(mysqli_error());
	while($data=mysqli_fetch_array($query1))
	{
		$toSearch=$data['item'].' india -wikipedia -pixabay -wikimedia -http://upload.wikimedia.org';
		//echo $toSearch;
		search($data['item'],$toSearch,$con);
		//echo $toSearch;
	}
	function search($item,$query,$con)
	{
